...
/*! @name PIO0_0 (number 31), U13[4]/TO_MUX_P0_0-ISP_RX
  @{ */
...
/*! @name PIO0_1 (number 32), U15[3]/U4[4]/P0_1-ISP_TX
  @{ */
...
/*! @name PIO0_15 (number 50), U3[12]/TDO-SWO_TRGT
  @{ */
#define BOARD_DEBUG_SWD_SWO_PORT 0U                   /*!<@brief PORT peripheral base pointer */
#define BOARD_DEBUG_SWD_SWO_PIN 15U                   /*!<@brief PORT pin number */
#define BOARD_DEBUG_SWD_SWO_PIN_MASK (1U << 15U)      /*!<@brief PORT pin mask */
                                                      /* @} */
