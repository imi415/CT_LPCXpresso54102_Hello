 ...
 *  0b0..Fast-mode plus. The I2C block will support Standard-mode, Fast-mode, and Fast-mode Plus, to the extent
 *       that the pin electronics support these modes. Any changes that need to be made to the pin controls, such as
 *       changing the drive strength or filtering, must be made by software via the IOCON register associated with
 *       each I2C pin,
 *  0b1..High-speed. In addition to Standard-mode, Fast-mode, and Fast-mode Plus, the I 2C block will support
 *       High-speed mode to the extent that the pin electronics support these modes. See Section 23.7.1.2 for more
 *       information.
 */
 ...
 *    Table 346 for details of state values and appropriate responses.
 ...
 *    automatically cleared when a 1 is written to the SLVCONTINUE bit in the MSTCTL register. The point in time
 *    when SlvPending is set depends on whether the I2C block is in HSCAPABLE mode. See Section
 *    23.7.1.2.2. When the I2C block is configured to be HSCAPABLE, HS master codes are detected
 *    automatically. Due to the requirements of the HS I2C specification, slave addresses must also be
 *    detected automatically, since the address must be acknowledged before the clock can be stretched.
 ...
 *    the Slave function. All other values are reserved. See Table 347 for state values and actions.
 ...
 *    function to acknowledge the address. It is cleared when another address cycle presents an
 *    address that does not match an enabled address on the Slave function, when slave software decides
 *    to NACK a matched address, or when there is a Stop detected on the bus. SLVSEL is not cleared
 ...
 *  0b1..Event time-out. The time between I2C bus events has been longer than the time specified by the I2C TIMEOUT register.
 */
 ...
 *    typically via an interrupt. When a DMA data transfer is complete, MSTDMA must be cleared prior
 *    to beginning the next operation, typically a Start or Stop.This bit is read/write.
 ...
 *    tBUF and t SU;STA have the same values and are also controlled by MSTSCLLOW.
 ...
 *  0b0..No effect.
 *  0b1..Continue. Informs the Slave function to continue to the next operation. This must be done after writing
 *       transmit data, reading received data, or any other housekeeping related to the next bus operation.
 */
...
typedef struct {
  ...
  union {                                          /* offset: 0x100 */
    __IO uint32_t CAP[13];                           /**< SCT capture register of capture channel, array offset: 0x100, array step: 0x4 */
    __IO uint32_t MATCH[13];                         /**< SCT match value register of match channels, array offset: 0x100, array step: 0x4 */
  };
       uint8_t RESERVED_2[204];
  union {                                          /* offset: 0x200 */
    __IO uint32_t CAPCTRL[13];                       /**< SCT capture control register, array offset: 0x200, array step: 0x4 */
    __IO uint32_t MATCHREL[13];                      /**< SCT match reload value register, array offset: 0x200, array step: 0x4 */
  };
 ...
 *  0b0..Low. The SSEL0 pin is active low. The value in the SSEL0 fields of the RXDAT, TXDATCTL, and TXCTL
 *       registers related to SSEL0 is not inverted relative to the pins.
 *  0b1..High. The SSEL0 pin is active high. The value in the SSEL0 fields of the RXDAT, TXDATCTL, and TXCTL
 *       registers related to SSEL0 is inverted relative to the pins.
 */
 ...
 *  0b0..Low. The SSEL1 pin is active low. The value in the SSEL1 fields of the RXDAT, TXDATCTL, and TXCTL
 *       registers related to SSEL1 is not inverted relative to the pins.
 *  0b1..High. The SSEL1 pin is active high. The value in the SSEL1 fields of the RXDAT, TXDATCTL, and TXCTL
 *       registers related to SSEL1 is inverted relative to the pins.
 */
 ...
 *  0b0..Low. The SSEL2 pin is active low. The value in the SSEL2 fields of the RXDAT, TXDATCTL, and TXCTL
 *       registers related to SSEL2 is not inverted relative to the pins.
 *  0b1..High. The SSEL2 pin is active high. The value in the SSEL2 fields of the RXDAT, TXDATCTL, and TXCTL
 *       registers related to SSEL2 is inverted relative to the pins.
 */
 ...
 *  0b0..Low. The SSEL3 pin is active low. The value in the SSEL3 fields of the RXDAT, TXDATCTL, and TXCTL
 *       registers related to SSEL3 is not inverted relative to the pins.
 *  0b1..High. The SSEL3 pin is active high. The value in the SSEL3 fields of the RXDAT, TXDATCTL, and TXCTL
 *       registers related to SSEL3 is inverted relative to the pins.
 */
...
/*! RXRDYEN - RX ready interrupt enable. Determines whether an interrupt occurs when receiver data is available.
 *  0b0..Disabled. No interrupt will be generated when receiver data is available.
 *  0b1..Enabled. An interrupt will be generated when receiver data is available in the RXDAT register.
 */
...
/*! TXRDYEN - TX ready interrupt enable. Determines whether an interrupt occurs when the transmitter holding register is available.
 *  0b0..Disabled. No interrupt will be generated when the transmitter holding register is available.
 *  0b1..Enabled. An interrupt will be generated when data may be written to TXDAT.
 */
 ...
 *  0b0..Disabled. No interrupt will be generated when a receiver overrun occurs.
 *  0b1..Enabled. An interrupt will be generated if a receiver overrun occurs.
 */
 ...
 *    is available.
 *  0b0..Disabled. No interrupt will be generated when the transmitter underruns.
 *  0b1..Enabled. An interrupt will be generated if the transmitter underruns.
 */
 ...
 *  0b0..Disabled. No interrupt will be generated when the SPI master function is idle.
 *  0b1..Enabled. An interrupt will be generated when the SPI master function is idle.
 */
 ...
 *       bits remain unchanged. For instance, when re-enabled, the USART will immediately generate a TxRdy
 *       interrupt (if enabled in the INTENSET register) or a DMA transfer request because the transmitter has been reset
